...
export default function CookiesPage() {
  ...
  return (
    <PageLayout>
      {/* Header */}
      <div className="bg-secondary-900 text-white py-6 lg:py-16">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-8">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-secondary-900 mb-2">Strictly Necessary Cookies</h3>
                  <p className="text-sm text-secondary-500 mb-4">Always Active</p>
                </div>
              </div>
              <p className="text-secondary-600 mb-4">
              ...
              <div className="bg-secondary-50 rounded-lg p-4">
                <h4 className="font-semibold text-secondary-900 mb-3">Examples of necessary cookies:</h4>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-8">
                ...
                <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <label className="flex items-center cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 border-secondary-300 rounded text-primary-600"
                    />
                  </label>
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-secondary-900 mb-1">Performance Cookies</h3>
                </div>
              </div>
              <p className="text-secondary-600 mb-4">
              ...
              <div className="bg-secondary-50 rounded-lg p-4">
                <h4 className="font-semibold text-secondary-900 mb-3">Examples of performance cookies:</h4>
                <ul className="space-y-2 text-sm text-secondary-600">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-secondary-400 rounded-full"></span>
                    Google Analytics
            ...
            <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-8">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-secondary-900 mb-1">Targeting & Marketing Cookies</h3>
                </div>
              </div>
              <p className="text-secondary-600 mb-4">
              ...
              <div className="bg-secondary-50 rounded-lg p-4">
                <h4 className="font-semibold text-secondary-900 mb-3">Examples of targeting cookies:</h4>
                <ul className="space-y-2 text-sm text-secondary-600">
                  <li className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 bg-secondary-400 rounded-full"></span>
          ...
          {/* Cookie Management */}
          <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-8 mb-8">
            <h2 className="text-2xl font-bold text-secondary-900 mb-6">Manage Your Preferences</h2>
            
            <div className="space-y-4 mb-6">
              {/* Necessary Toggle (Disabled) */}
              <div className="flex items-center justify-between p-4 bg-secondary-50 rounded-lg">
                <div>
                  <h4 className="font-semibold text-secondary-900">Strictly Necessary</h4>
                  <p className="text-sm text-secondary-500">Cannot be disabled</p>
                </div>
                <div className="w-12 h-7 bg-success-500 rounded-full flex items-center justify-end pr-1">
              ...
              <div className="flex items-center justify-between p-4 border border-secondary-200 rounded-lg">
                <div>
                  <h4 className="font-semibold text-secondary-900">Performance Cookies</h4>
                  <p className="text-sm text-secondary-500">Improve our services</p>
                </div>
                <button
                  onClick={() => handlePreferenceChange('performance')}
                  className={`w-12 h-7 rounded-full flex items-center transition-colors ${
                    preferences.performance ? 'bg-primary-600' : 'bg-secondary-300'
                  }`}
                >
                  <div
              ...
              <div className="flex items-center justify-between p-4 border border-secondary-200 rounded-lg">
                <div>
                  <h4 className="font-semibold text-secondary-900">Targeting & Marketing</h4>
                  <p className="text-sm text-secondary-500">Personalized content</p>
                </div>
                <button
          ...
          {/* Additional Info */}
          <div className="bg-primary-50 border border-primary-200 rounded-lg p-6 mb-8 flex gap-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-8 mb-8">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-secondary-900 mb-2">Do you share my cookie data with third parties?</h3>
                <p className="text-secondary-600">
              ...
              <div>
                <h3 className="text-lg font-semibold text-secondary-900 mb-2">How long do cookies last?</h3>
                <p className="text-secondary-600">
              ...
              <div>
                <h3 className="text-lg font-semibold text-secondary-900 mb-2">Can I opt out of all cookies?</h3>
                <p className="text-secondary-600">
              ...
              <div>
                <h3 className="text-lg font-semibold text-secondary-900 mb-2">How do I delete cookies?</h3>
                <p className="text-secondary-600">
          ...
          {/* Contact Section */}
          <div className="bg-secondary-50 rounded-lg border border-secondary-200 p-8 text-center">
            <h2 className="text-2xl font-bold text-secondary-900 mb-4">Questions About Our Cookie Policy?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/privacy" className="inline-flex items-center justify-center border border-secondary-300 text-secondary-700 px-6 py-3 rounded-lg font-medium hover:bg-secondary-50 transition-colors">
                Privacy Policy
              </Link>
            </div>
          </div>
