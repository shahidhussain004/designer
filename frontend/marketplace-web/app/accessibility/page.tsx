...
export default function AccessibilityPage() {
  ...
  return (
    <PageLayout>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">WCAG 2.1 AA Compliance</h2>
              ...
              <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                <p className="text-sm text-gray-600 font-semibold mb-4">Our commitment includes:</p>
                <ul className="space-y-2">
                  <li className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700">Keyboard navigation for all interactive elements</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700">Sufficient color contrast ratios (minimum 4.5:1 for text)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700">Descriptive alt text for all images and visual content</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <svg className="w-5 h-5 text-primary-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700">Accessible form inputs with clear labels</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="mb-16">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Key Accessibility Features</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {/* Feature 3 */}
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <h3 className="font-semibold text-gray-900 mb-2">Color Blindness Support</h3>
                  <p className="text-sm text-gray-600">
                ...
                {/* Feature 4 */}
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <h3 className="font-semibold text-gray-900 mb-2">Flexible Text Display</h3>
                  <p className="text-sm text-gray-600">
                ...
                {/* Feature 6 */}
                <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                  <h3 className="font-semibold text-gray-900 mb-2">Motion & Animation Control</h3>
                  <p className="text-sm text-gray-600">
        ...
        <section className="mb-16">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Accessibility in Design Excellence</h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-primary-500 pl-6 py-2">
                  <h3 className="font-semibold text-gray-900 text-lg mb-2">Universal Design</h3>
                ...
                <div className="border-l-4 border-primary-500 pl-6 py-2">
                  <h3 className="font-semibold text-gray-900 text-lg mb-2">Clear Visual Hierarchy</h3>
                  <p className="text-gray-700">
                ...
                <div className="border-l-4 border-primary-500 pl-6 py-2">
                  <h3 className="font-semibold text-gray-900 text-lg mb-2">Flexible Layouts</h3>
                  <p className="text-gray-700">
        ...
        <section className="mb-16 bg-gray-50 rounded-lg px-6 py-8 border border-gray-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Accessibility for All Users</h2>
        ...
        <section className="mb-16">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-gray-900 mb-3">Accessibility Statement</h2>
              <p className="text-gray-700 mb-6 leading-relaxed">
        ...
        {/* Resources & Standards */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Accessibility Resources</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a 
              ...
              className="block p-6 bg-gray-50 border border-gray-200 rounded-lg hover:border-primary-500 hover:shadow-md transition-all"
            >
        ...
        <section className="mb-16 bg-gradient-to-br from-primary-50 to-primary-100 rounded-lg px-8 py-12 border border-primary-200">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Join an Accessible Design Community</h2>
          <p className="text-gray-700 mb-6 leading-relaxed">
          ...
          <div className="flex gap-4">
            ...
            <Link
              href="/contact"
              className="px-6 py-3 bg-white text-primary-600 rounded-lg font-semibold border-2 border-primary-600 hover:bg-gray-50 transition-colors"
            >
              Contact Us
            </Link>
          </div>
