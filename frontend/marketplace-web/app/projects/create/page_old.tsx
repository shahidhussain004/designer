        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-secondary-400 mt-1">Find the right freelancer for your project</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="lg:col-span-2">
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-3 border border-secondary-300 rounded-lg outline-none bg-white"
                  >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="100"
                    required
                    className="w-full pl-10 pr-4 py-3 border border-secondary-300 rounded-lg focus:outline-none"
                    placeholder="0"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center justify-end gap-4">
                <Link
                  href="/dashboard"
                  className="px-6 py-2 border border-secondary-300 text-secondary-700 rounded-lg hover:bg-secondary-50 transition-colors font-medium"
                >
                  Cancel
                </Link>
                <button
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 sticky top-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="font-semibold text-secondary-900">Tips for a Great Project Post</h2>
              </div>
