...
export default function ApplicationSuccessPage() {
  ...
  return (
    <PageLayout>
      <div className="bg-gradient-to-b from-green-50 via-white to-gray-50 min-h-screen py-12 lg:py-20">
        <div className="mx-auto max-w-3xl px-4">
          {/* Success Hero Section */}
          <div className="text-center mb-12">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-green-100 to-emerald-100 rounded-full mb-6 animate-bounce">
          ...
          <div className="bg-white rounded-xl shadow-lg border border-green-100 p-8 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {/* Left Column - Reference Info */}
              <div>
                <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2">Application Reference</p>
                ...
                <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2 mt-6">Submitted On</p>
                <p className="text-gray-900 font-medium">{applicationData.createdAt}</p>
              </div>

              {/* Right Column - Contact Info */}
              <div>
                <p className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-2">Your Information</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <h3 className="font-bold text-gray-900 mb-2">Prepare Your Story</h3>
              <p className="text-sm text-gray-600">
          ...
          <div className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl border border-primary-200 p-8 mb-12">
            <div className="text-center">
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready for More Opportunities?</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href={`/jobs/${jobId}`}
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border border-gray-300 text-gray-900 rounded-lg hover:bg-gray-50 transition-colors font-medium"
                >
