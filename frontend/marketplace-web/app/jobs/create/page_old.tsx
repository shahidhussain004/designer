      ...
      <div className="bg-white border-b border-secondary-200 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-secondary-900">Post a New Job</h1>
              <p className="text-sm text-secondary-600 mt-1">Fill out all details to attract the best candidates</p>
            </div>
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          ...
          <div>
            ...
            <input
              ...
              disabled
              value={companyName}
              className="w-full px-4 py-2 bg-secondary-100 border border-secondary-300 rounded-lg text-secondary-600 cursor-not-allowed"
            />
            <p className="text-xs text-secondary-500 mt-1">Auto-filled from your account</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              {errors.title && <p className="text-error-600 text-sm mt-1">{errors.title}</p>}
            </div>
            ...
            <div>
              ...
              {errors.categoryId && <p className="text-error-600 text-sm mt-1">{errors.categoryId}</p>}
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Positions Available */}
            <div>
              <label htmlFor="positionsAvailable" className="block text-sm font-medium text-secondary-700 mb-1">
                Positions Available
              </label>
              <input
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="isRemote" className="ml-2 text-sm font-medium text-secondary-700">
            ...
            {formData.isRemote && (
              <div>
                <label htmlFor="remoteType" className="block text-sm font-medium text-secondary-700 mb-1">
                  Remote Type
                </label>
                <select
                  id="remoteType"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              {errors.location && <p className="text-error-600 text-sm mt-1">{errors.location}</p>}
            </div>
            ...
            {/* Travel Requirement */}
            <div>
              <label htmlFor="travelRequirement" className="block text-sm font-medium text-secondary-700 mb-1">
                Travel Requirement
              </label>
              <select
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500"
              />
              <label htmlFor="showSalary" className="ml-2 text-sm font-medium text-secondary-700">
            ...
            <div className="grid grid-cols-3 gap-4">
              {/* Minimum Salary */}
              <div>
                <label htmlFor="salaryMinCents" className="block text-sm font-medium text-secondary-700 mb-1">
                  Minimum Salary
                </label>
                <input
                  id="salaryMinCents"
              ...
              {/* Maximum Salary */}
              <div>
                <label htmlFor="salaryMaxCents" className="block text-sm font-medium text-secondary-700 mb-1">
                  Maximum Salary
                </label>
                <input
                  id="salaryMaxCents"
              ...
              {/* Currency & Period */}
              <div>
                <label htmlFor="salaryCurrency" className="block text-sm font-medium text-secondary-700 mb-1">
                  Currency / Period
                </label>
            ...
            {errors.salary && <p className="text-error-600 text-sm mt-1">{errors.salary}</p>}
          </div>
        </div>

        {/* Requirements Section */}
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          <h2 className="text-lg font-semibold text-secondary-900 mb-4">Requirements & Skills</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              {errors.requirements && <p className="text-error-600 text-sm mt-1">{errors.requirements}</p>}
            </div>
            ...
            {/* Required Skills */}
            <div>
              <label htmlFor="requiredSkills" className="block text-sm font-medium text-secondary-700 mb-1">
                Required Skills
              </label>
              <textarea
                id="requiredSkills"
                ...
                className="w-full px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              <p className="text-xs text-secondary-500 mt-1">Enter skills separated by commas</p>
            </div>

            {/* Preferred Skills */}
            <div>
              <label htmlFor="preferredSkills" className="block text-sm font-medium text-secondary-700 mb-1">
                Preferred Skills
              </label>
              <textarea
                id="preferredSkills"
            ...
            {/* Education Level */}
            <div>
              <label htmlFor="educationLevel" className="block text-sm font-medium text-secondary-700 mb-1">
            ...
            {/* Certifications */}
            <div>
              <label htmlFor="certifications" className="block text-sm font-medium text-secondary-700 mb-1">
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              <p className="text-xs text-secondary-500 mt-1">Enter certifications separated by commas</p>
            </div>
          </div>
        </div>
        ...
        {/* Benefits Section */}
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          <h2 className="text-lg font-semibold text-secondary-900 mb-4">Benefits & Special Requirements</h2>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              <p className="text-xs text-secondary-500 mt-1">Enter benefits separated by commas</p>
            </div>

            {/* Perks */}
            <div>
              <label htmlFor="perks" className="block text-sm font-medium text-secondary-700 mb-1">
                Perks
              </label>
              <textarea
                id="perks"
                ...
                className="w-full px-4 py-2 border border-secondary-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
              <p className="text-xs text-secondary-500 mt-1">Enter perks separated by commas</p>
            </div>
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500"
              />
              <label htmlFor="visaSponsorship" className="ml-2 text-sm font-medium text-secondary-700">
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 text-primary-600 border-secondary-300 rounded focus:ring-primary-500"
              />
              <label htmlFor="securityClearanceRequired" className="ml-2 text-sm font-medium text-secondary-700">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 mb-6">
          <h2 className="text-lg font-semibold text-secondary-900 mb-4">Application Settings</h2>

          <div className="space-y-4">
            {/* Application Email */}
            <div>
              <label htmlFor="applicationEmail" className="block text-sm font-medium text-secondary-700 mb-1">
                Application Email
              </label>
              <input
                id="applicationEmail"
            ...
            {/* Application URL */}
            <div>
              <label htmlFor="applicationUrl" className="block text-sm font-medium text-secondary-700 mb-1">
                Application URL
              </label>
              <input
                id="applicationUrl"
            ...
            <div>
              <label htmlFor="applyInstructions" className="block text-sm font-medium text-secondary-700 mb-1">
                Application Instructions
              </label>
              <textarea
              ...
              />
                ...
                <div>
                  ...
                  <p className="text-xs text-secondary-500 mt-1">Choose Draft to save and publish later, or Open to publish immediately.</p>
                </div>
          </div>
        </div>
        ...
        <div className="flex gap-4">
          <button
            type="submit"
            disabled={isPending}
            className="flex-1 px-6 py-3 bg-primary-600 text-white font-medium rounded-lg hover:bg-primary-700 disabled:bg-secondary-400 disabled:cursor-not-allowed transition-colors"
          >
          ...
          <button
            ...
            disabled={isPending}
            className="flex-1 px-6 py-3 border border-secondary-300 text-secondary-700 font-medium rounded-lg hover:bg-secondary-50 disabled:bg-secondary-100 disabled:cursor-not-allowed transition-colors"
          >
            Cancel
          </button>
        </div>
