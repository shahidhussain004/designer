...
export default function FreelancerProfilePage() {
  ...
  return (
    <PageLayout>
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-secondary-900 via-secondary-800 to-primary-900 text-white py-12 lg:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 items-start">
            ...
            <div className="flex-1">
              ...
              <p className="text-secondary-300 text-lg">@{profile.username}</p>
              ...
              <div className="flex flex-wrap items-center gap-4 mt-4">
                ...
                {typeof profile.ratingAvg !== 'undefined' && (
                  <span className="flex items-center gap-1">
                    ...
                    <span className="text-secondary-400">({profile.ratingCount} reviews)</span>
                  </span>
                )}
              </div>
              ...
              <div className="flex gap-6 mt-4">
                {profile.hourlyRate && (
                  <div>
                    <p className="text-xs text-secondary-400">Hourly Rate</p>
                    <p className="text-xl font-bold">${profile.hourlyRate}/hr</p>
                  </div>
                )}
                {typeof profile.completionRate !== 'undefined' && (
                  <div>
                    <p className="text-xs text-secondary-400">Job Success</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {profile.skills && profile.skills.length > 0 && (
                <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6">
                  <h2 className="text-lg font-semibold text-secondary-900 mb-3">Skills & Expertise</h2>
                ...
                <div className="space-y-3">
                  ...
                  {profile.phone && (
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-secondary-700">{profile.phone}</span>
                    </div>
                  )}
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6">
                <h2 className="text-lg font-semibold text-secondary-900 mb-4">Statistics</h2>
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-2 border-b border-secondary-100">
                    ...
                    <span className="font-semibold text-secondary-900">{profile.completionRate || 0}%</span>
                  </div>
              ...
              {/* Quick Actions */}
              <div className="bg-white rounded-lg shadow-sm border border-secondary-200 p-6 space-y-3">
                ...
                <button className="w-full border border-secondary-300 text-secondary-700 py-3 rounded-lg font-medium hover:bg-secondary-50 transition-colors flex items-center justify-center gap-2">
